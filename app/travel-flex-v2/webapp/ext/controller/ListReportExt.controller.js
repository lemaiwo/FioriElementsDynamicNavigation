sap.ui.define([], function () {
  //	"use strict";
  sap.ui.controller("travelflexv2.ext.controller.ListReportExt", {
    onListNavigationExtension: function (oEvent) {
      ...
      switch (object.TravelID) {
        case 4131:
          navigationProperty =
            "to_Booking(BookingUUID='36997221A8E4645C17002DF03754AB66',IsActiveEntity=true)";
          break;
      }
      if (navigationProperty) {
        let fnNavigate = function () {
          return new Promise(function (fnResolve, fnReject) {
            model.createBindingContext(
              navigationProperty,
              bindingContext,
              {},
              function (target) {
